...
# Fitting the KNN classifier to the training set and Predicting the Test set Results
# install.packages('class')
# library(class)
y_pred = knn(train = trs[, -3],
             test = tes[, -3],
             cl = trs[, 3],
             k = 5)
...
y_grid = knn(train = trs[, -3], test = grid_set, cl = trs[, 3], k = 5)
plot(set[, -3],
